 ...
 * GitHub: Pleisterman 
 * 
 * Purpose: this class handles coonstruction of sqlite statements
 *
...
class SqliteParser
{
    ...
    public function __construct( Debugger $debugger )
    {
        ...
        // debug info
        $debugger->logInformation( 'SqliteParser construct. ' );
    ...
    public function getUpdateStatement( $selection ){
    ...
    public function getInsertStatement( $selection ){
        // create sql statement
    ...
    public function getDeleteStatement( $selection ){
        // create sql statement
