 ...
 *  Project: MbAdmin
 * 
 *  File: /MbAdmin/Database/Data/Rides/RidesCheckStartAndEndOverlap.php
 * 
 *  Last Revision:  17-01-2017
 * 
 *  Purpose: 
 *          this class checks if the odometer start and end value of a ride overlaps with
...
class RidesCheckStartAndEndOverlap
{
    ...
    public function checkStartAndEndOverlap( $dataController, $id, $values, $isUpdate ){
         // get selection    
