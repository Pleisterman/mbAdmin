 ...
 *  Project: MbAdmin
 * 
 *  File: /MbAdmin/Database/Data/Rides/RidesInsertRow.php
 * 
 *  Last Revision:  17-01-2017
 * 
 *  Purpose: 
 *          this class inserts a row in the rides table
 *                      
 *  Author: Pleisterman
...
class RidesInsertRow
{
    ...
    public function insertRow( $dataController, $values ){
        ...
        $vehiclesController->updateUsed( 'vehicles', $values['vehicleId'] );
        // update vehicle in veclies table
