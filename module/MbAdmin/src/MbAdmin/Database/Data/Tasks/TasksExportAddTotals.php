 ...
 *  Project: MbAdmin
 * 
 *  File: /MbAdmin/Database/Data/Tasks/TasksExportAddTotals.php
 * 
 *  Last Revision:  16-01-2017
 * 
 *  Purpose: 
 *          this class adds totals to the tasks export
 * 
 *  Author: Sharesoft
...
class TasksExportAddTotals
{
    ...
    public function addTotals( $selection, &$rows ){
        ...
        switch ( $selection ) {
            ...
            default: {
                $this->debugger->logInformation( 'error TasksExportAddTotals, selection not found selection: ' . $selection );
            }
        }        
        // done which totals
    }        
