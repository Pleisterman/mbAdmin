 ...
 *  Project: MbAdmin
 * 
 *  File: /MbAdmin/Database/Data/Vat/VatGetSelectData.php
 * 
 *  Last Revision:  26-01-2017
 * 
 *  Purpose: 
 *          this class creates an array with a list of 'open' vat
...
class VatGetSelectData
{
    ...
    public function getSelectData( $dataController, $id, $lastUpdated ){
        // debug info
        $this->debugger->logInformation( 'VatGetSelectData id: ' . $id );
        ...
        $getListController = new VatGetList( $this->configId, $this->workDirectory, $this->serviceLocator, $this->debugger );
        // get list
