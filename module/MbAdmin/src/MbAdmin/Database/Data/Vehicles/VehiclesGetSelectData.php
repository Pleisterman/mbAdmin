 ...
 *  Project: MbAdmin
 * 
 *  File: /MbAdmin/Database/Data/Vehicles/VehiclesGetSelectData.php
 * 
 *  Last Revision:  17-01-2017
 * 
 *  Purpose: 
 *          this class creates an array with a list of 'open' vehicles
...
class VehiclesGetSelectData
{
    ...
    public function getSelectData( $dataController, $id, $lastUpdated ){
        // debug info
        $this->debugger->logInformation( 'VehiclesGetSelectData id: ' . $id );
        ...
        $getListController = new VehiclesGetList( $this->configId, $this->workDirectory, $this->serviceLocator, $this->debugger );
        // get list
