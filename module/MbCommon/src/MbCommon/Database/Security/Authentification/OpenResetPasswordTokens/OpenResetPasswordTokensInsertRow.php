 ...
 *  Project: MbCommon
 * 
 *  File: \MbCommon\Database\security\Authentification\OpenResetPasswordTokens\OpenResetPasswordTokensInsertRow.php
 * 
 *  Last Revision:  22-01-2017
 * 
 *  Purpose: 
 *          this class inserts a row in the openResetPasswordTokens table
...
class OpenResetPasswordTokensInsertRow
{
    private $debugger = null; 
    private $serviceLocator = null; 
    private $configId = null; 
    private $config = array( 
        'OpenResetPasswordTokenExpirationPeriod'   => 7200     // 2 * 60 * 60 seconds
    );
    ...
    private function getSelection( $token ) {
        ...
        $expires->add( new \DateInterval( 'PT' . $this->config['OpenResetPasswordTokenExpirationPeriod'] . 'S' ) );
