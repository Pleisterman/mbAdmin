 ...
 *  Project: MbCommon
 * 
 *  File: \MbCommon\Database\security\Authentification\ResetPasswordTokens\ResetPasswordTokensDeleteRowByToken.php
 * 
...
class ResetPasswordTokensDeleteRowByToken
{
    ...
    public function deleteRow( $dataController, $token ){
        // debug info
        $this->debugger->LogInformation( 'ResetPasswordTokensDeleteRowByToken token: ' . $token );
