 ...
 *  Project: MbCommon
 * 
 *  File: \MbCommon\Database\security\Authentification\ResetPasswordTokens\ResetPasswordTokensInsertRow.php
 * 
...
class ResetPasswordTokensInsertRow
{
    private $debugger = null; 
    private $serviceLocator = null; 
    private $configId = null; 
    private $config = array( 
        'resetPasswordTokenExpirationPeriod'   => 120     // 2 * 60 seconds
    );
    ...
    private function getSelection( $token ) {
        ...
        $expires->add( new \DateInterval( 'PT' . $this->config['resetPasswordTokenExpirationPeriod'] . 'S' ) );
