 ...
 *  Project: MbCommon
 * 
 *  File: \MbCommon\Database\security\Authentification\SendResetPasswordEmailTokens\SendResetPasswordEmailTokensClean.php
 * 
...
class SendResetPasswordEmailTokensClean
{
    ...
    public function clean( $dataController ){
        // debug info
        $this->debugger->LogInformation( 'SendResetPasswordEmailTokensClean' );
