 ...
 *  Project: MbCommon
 * 
 *  File: \MbCommon\Database\security\Authentification\SendResetPasswordEmailTokens\SendResetPasswordEmailTokensValidate.php
 * 
...
class SendResetPasswordEmailTokensValidate
{
    ...
    public function validate( $dataController, $token ){
        ...
        // debug info
        $this->debugger->logInformation( 'SendResetPasswordEmailTokensValidate' );
        ...
        // debug info
        $this->debugger->logInformation( 'SendResetPasswordEmailTokensValidate invalid token: '. $token );
