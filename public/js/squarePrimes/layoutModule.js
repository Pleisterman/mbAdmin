...
( function( squarePrimes ){
    squarePrimes.layoutModule = function( ) {


    /*
     *  module layoutModule 
     *  purpose:
     *   this module controls layoutModule for the squarePrimes.
     *   
     *  functions: 
 *  events: 
 */
        ...
        self.layout = { 'leftColumnWidth' : 210,            // px, constant                        
                        'rightColumnWidth' : 2,             // px, constant                        
                        'topRowHeight' : 0,                // percentage of window height
                        'middleRowHeight' : 100,             // percentage of window height
                        'bottomRowHeight' : 0 };           // percentage of window height
        // functions
        ...
        self.addHtml = function() {
            ...
            html += '<div id="layout" style="position:absolute;background-color:lightgreen;z-index:2;">';
