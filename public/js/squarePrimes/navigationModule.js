 ...
 * GitHub: Pleisterman 
 * 
 * Purpose: this module controls the navigation for the squarePrimes application
 *          selection of menus
...
( function( squarePrimes ){
    squarePrimes.navigationModule = function( ) {
     ...
     */
        ...
        self.debugOn = true;
        self.selectedMenu = "";                                 
        self.documentTitle = { "id" :           "squarePrimesDocumentTitle", // document title translation
                               "translation" :  null };
        ...
        self.translate = function(){
            ...
            squarePrimes.translate( 'navigation', translationIds, self.translateCallback );
        };
