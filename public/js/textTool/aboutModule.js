 ...
 * GitHub: Pleisterman 
 * 
 * Purpose: this file controls the aboutModule for the application TextTool
 * 
 *       functions:
 *           private:
...
( function( textTool ){
     ...
     */
        ...
        self.menuText = {   "id" :                      "aboutMenu",                // translation for menu text
                            "translation" :             null };
        self.htmlItems = {  "aboutHeader" :           { "translation" : 'Tekst gereedschap.' },       // translations for html elements
                            "aboutSubHeader" :        { "translation" : 'Handig begrijpelijk uw teksten aanpassen.' },
                            "aboutText" :             { "translation" : 'Dit programma is ontwikkeld om hanidg een tekst te wijzigen.<br>' } };
        // functions
        ...
        self.createContent = function(){
            ...
            var html = '';
                ...
                html += '>';
                    html += '<div class="panel-heading">';
                        html += self.htmlItems["aboutHeader"]["translation"];
                    html += '</div>'; 
                    html += '<div class="panel-body">';
                        html += '<b>';
                        html += self.htmlItems["aboutSubHeader"]["translation"];
                        html += '</b><br>';
                        html += self.htmlItems["aboutText"]["translation"];
            ...
            // set event for clean up
            jsProject.subscribeToEvent( 'clearContent', self.clearContent );
        ...
        self.clearContent = function(){
            ...
            // remove event for clean up
            jsProject.unSubscribeFromEvent( 'clearContent', self.clearContent );
        ...
        self.translate = function(){
            ...
            // translate
            textTool.translate( 'about', translationIds, self.translateCallback );
        };
