 ...
 * GitHub: Pleisterman 
 * 
 * Purpose: this module controls languages for the application TextTool
 ...
 *          debug
 *       function links in textTool module:
 *           translate          
 * 
...
( function( textTool ){
    textTool.languageModule = function( ) {
     ...
     */
        ...
        self.language = textTool.defaultLanguage;   // selected language
        ...
        self.construct = function() {
            ...
            // create the function links in textTool
            textTool.translate = self.translate;
            // done create the function links in textTool
        ...
        self.translate = function( subject, ids, callback ){
            ...
            // make the ajax call
            jsProject.post( '/Tools/TextTool/translate', data, callback );
        };
        // debug 
