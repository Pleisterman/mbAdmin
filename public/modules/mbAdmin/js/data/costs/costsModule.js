 ...
 *  Project: MbAdmin
 * 
 *  File: /mbAdmin/js/data/costs/costsModule.js
 * 
...
( function( sharesoft ){
    ...
    sharesoft.costsModule = function( ) {
        ...
        self.MODULE = 'costsModule';                // string: MODULE
        self.debugOn = false;                       // boolean: debug
        self.id = 'costs';                          // string: id
        self.costsList = null;                      // module: costsList
        ...
        self.addVatSelect = function(){
        // FUNCTION: addVatSelect( void ) void
            
            // get the select module
            var vatSelectModule = jsProject.getValue( 'vatSelectModule', 'select' );
            // get projectId object from data object
            var vatIdObject = jsProject.getJsonValue( self.dataObject, ['id=vatId'] );  
            // set select module value 
            vatIdObject['selectModule'] = vatSelectModule;

        // DONE FUNCTION: addVatSelect( void ) void
        };
        ...
        // FUNCTION: load( function: callback ) void
            ...
            if( sharesoft.options['costsHeaderOpen']['value'] === 'true' ){
                ...
                // load the list data
                self.costsList.loadList( self.listSelectionsOptions['currentSelection'], self.listSelectionsOptions['date'], self.fillList );
            }
            // done header is open
        ...
        // FUNCTION: refreshDayList( string: date ) void
            ...
            // refresh list
            self.costsList.loadList( self.listSelectionsOptions['currentSelection'],  date, self.fillList );
