...
( function( sharesoft ){
    ...
    sharesoft.projectsModule = function( ) {
        // PRIVATE:
        ...
        // FUNCTION: construct( void ) void
            ...
            self.dataObjectModule = new sharesoft.projectDataObjectModule();
            // get dataObject
            self.dataObject = self.dataObjectModule.getDataObject();
            
            // create the projectsList module
            self.projectsList = new sharesoft.projectsListModule();
            // create the list
        ...
        // FUNCTION addProjectContacts( void ) void
            ...
            projectContactsObject['module'] =  new sharesoft.projectContactsModule();            
        ...
        // FUNCTION load( function: callback ) void
            ...
            // header open
            if( sharesoft.options['projectsHeaderOpen']['value'] === 'true' ){
                // debug info
        ...
        // FUNCTION listCallback( string: action, string: id ) void
            ...
            switch( action ){
                ...
                case 'header' : {
                    ...
                    if( sharesoft.options['projectsHeaderOpen']['value'] === 'true' ){
                        // was open now closed
                        sharesoft.setOption( 'projectsHeaderOpen', 'false' );
                    }
                    else {
        ...
        // FUNCTION openList( void ) void 
            ...
            if( sharesoft.options['projectsHeaderOpen']['value'] !== 'true' ){
                // was closed now open
                sharesoft.setOption( 'projectsHeaderOpen', 'true' );
                // load the list
                self.projectsList.load( self.fillList );
            }
        ...
        // FUNCTION: openInitialSelection( void ) void
            ...
            if( sharesoft.options['openSubject']['value'] === 'projects' ){
        ...
        // FUNCTION: fillList( array: rows ) void
            ...
            if( sharesoft.options['projectsHeaderOpen']['value'] === 'true' ){
                ...
                // create options
                var options = {
                    'headerText'    :   sharesoft.translations['lastUsedProjects'],
                    'rows'          :   rows
                };
                // done create options
        ...
        // FUNCTION: getRow( string: id ) void
            ...
            // set open subject
            sharesoft.setOption( 'openSubject', 'projects' );
            // set open id
