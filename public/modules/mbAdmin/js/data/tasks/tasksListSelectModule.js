 ...
 *  Project: MbAdmin
 *  
 *  File: /mbAdmin/js/data/tasks/tasksListSelectModule.js
 * 
...
( function( pleisterman ){
    ...
    // MODULE: tasksListSelectModule( void ) 
    
    pleisterman.tasksListSelectModule = function( ) {
    
        // PRIVATE:
        var self = this;                                    // object: self
        self.MODULE = 'tasksListSelectModule';              // string: MODULE
    ...
    // DONE MODULE: tasksListSelectModule( void ) 
})( pleisterman );
