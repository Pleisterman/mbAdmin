 ...
 *  Project: MbAdmin
 * 
 *  File: /mbAdmin/js/data/vehicles/vehicleDataObjectModule.js
 * 
 *  Last Revision: 16-01-2017
 * 
 *  Purpose: 
 *      this module contains the structure of the dataObject for vehicles
...
( function( sharesoft ){
    ...
    // MODULE: vehicleDataObjectModule( void ) void 
    
    sharesoft.vehicleDataObjectModule = function( ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                    // object: self
        self.MODULE = 'vehicleDataObjectModule';            // string:  MODULE
        ...
        self.dataObject = [                                 // json: data object
            ...
            {                                               // json: contactId, currently unused
                'id'                :   'contactId',        // string: id
                'type'              :   'noDisplay',        // string: display type: noDisplay
                'value'             :   '',                 // string: value
                'defaultValue'      :   null                // string: default value    
            ...
            {                                               // json: identification
                ...
                'displayOptions'    :   {                   // json: display options
                    'label'         :   {                   // json: label
                        'text'          :   sharesoft.translations['identification'] // string: label TRANSLATION: identification
                    },                                      // done json: label
                    'emptyError'    :   true,               // boolean: empty error
                    'input'         :   {                   // json: input
            ...
            {                                               // json: odometerStart
                ...
                'displayOptions'    :   {                   // json: display options
                    ...
                    'label'             :   {               // json: label
                        'text'          :   sharesoft.translations['odometerStart'] // string: label TRANSLATION: odometerStart
                    },                                      // done json: label
                    'emptyError'    :   true,               // boolean empty error
                    'input'         :   {                   // json: input
        ...
        // FUNCTION: update( function: updateCallback, function: reloadCallback ) void
            ...
            $.each( self.dataObject, function( index, value ) {
                ...
                if( value['id'] !== 'id' && value['id'] !== 'vehicleProjects' ){
                    // set value
    ...
    // DONE MODULE: vehicleDataObjectModule( void ) void 
})( sharesoft );
