 ...
 *  Project: MbAdmin 
 * 
 *  File: /mbAdmin/data/vehicles/vehiclesSelectModule.js
 * 
...
( function( pleisterman ){
    ...
    // MODULE: vehiclesSelectModule( void ) void
    
    pleisterman.vehiclesSelectModule = function( ) {
        // PRIVATE:
        
        // MEMBERS
        var self = this;                                    // object: self
        self.MODULE = 'vehiclesSelectModule';               // string: MODULE
        self.debugOn = false;                               // boolean: debug
        self.options = {                                    // json: options
            'selectCallback'  :   null                      // function: select callback
        };                                                  // done json: options
        self.openData = {                                   // json: open data
            'updated'   :       null,                       // dateTime: updated     
            'rows'      :       null                        // json: rows
        };                                                  // done json: open data
        self.closedData = {                                 // json: closed data
            'updated'   :       null,                       // dateTime: updated  
            'rows'      :       null                        // json: rows
        };                                                  // done json: closed data
        ...
        // FUNCTION: lisSelectorLoadCallback( void ) void
            ...
            var options = {
                ...
                'headerText'            :   pleisterman.translations['vehicles'],
    ...
    // DONE MODULE: vehiclesSelectModule( void ) void
})( pleisterman );
