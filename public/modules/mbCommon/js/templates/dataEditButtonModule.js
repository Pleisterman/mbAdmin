...
( function( sharesoft ){
    ...
    sharesoft.dataEditButtonModule = function( contentId, values, isEdit  ) {
        // PRIVATE:
        ...
        self.inputOptions = {                                           // json: input options
            ...
            'lineHeight'            :   sharesoft.getSetting( 'dataEditInputFontSize' ),    // css font line height
            'fontWeight'            :   sharesoft.getSetting( 'dataEditbuttonFontWeight' ), // css font weight
            'color'                 :   sharesoft.colors['buttonColor']['color'],           // css colro: color
        ...
        // FUNCTION: setSelectedDisplay( void ) void
            ...
            $( '#' + self.inputOptions['id'] ).css( 'color', sharesoft.colors['buttonColor']['color'] );
        ...
        // FUNCTION: updateButtonsDisplay( void ) void
            ...
            if( self.inputOptions['mouseOver'] || self.inputOptions['hasFocus'] ){
                ...
                // mouse out -> background color, color default
                $( '#' + self.inputOptions['id'] ).css( 'background-color', sharesoft.colors['buttonBackgroundColor']['color'] );
                // mouse out -> color, color default
                $( '#' + self.inputOptions['id'] ).css( 'color', sharesoft.colors['buttonColor']['color'] );
            }
