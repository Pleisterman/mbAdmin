...
( function( sharesoft ){
    ...
    sharesoft.resetPasswordDialogModule = function( ) {
        // PRIVATE:
        ...
        self.headerOptions = {                                          // json: header options  
            ...
            'element'               :   'div',                          // string html element type 
            'text'                  :   sharesoft.translations['passwordResetHeader'],                // string: text
        ...
        self.subHeaderOptions = {                                         // json: sub header options        
            ...
            'element'               :   'div',                          // string: html element type 
            'text'                  :   sharesoft.translations['passwordResetSubHeader'],       // string: text
        ...
        // FUNCTION: addPassword( void ) void
            ...
            // set text    
            self.labelOptions['text'] = sharesoft.translations['passwordNew'];
            // add label to item
        ...
        // FUNCTION: addPasswordRepeat( void ) void
            ...
            // set text    
            self.labelOptions['text'] = sharesoft.translations['passwordRepeat'];
            // add label to item
            $( '#' + self.itemOptions['id'] ).append( jsProject.jsonToElementHtml( self.labelOptions ) );
            // set id    
        ...
        // FUNCTION: addPasswordStrength( void ) void
            ...
            // set text    
            self.labelOptions['text'] = sharesoft.translations['passwordStrength'];
            // add label to item
            $( '#' + self.itemOptions['id'] ).append( jsProject.jsonToElementHtml( self.labelOptions ) );
        ...
        // FUNCTION: addButtons( void ) void
            ...
            // set text
            self.buttonOptions['text'] =  sharesoft.translations['showPassword'];
        ...
        // FUNCTION: togglePassword( void ) void
            ...
            if( self.passwordVisible ){
                ...
                // set button text
                $( '#' + self.dialogOptions['id'] + 'ShowPassword' ).html( sharesoft.translations['showPassword'] );
            }
            else {
                // set input type password
                ...
                // set button text
                $( '#' + self.dialogOptions['id'] + 'ShowPassword' ).html( sharesoft.translations['hidePassword'] );
            }
        ...
        // FUNCTION: hasDataErrors( void ) void
            ...
            // validate password
            if( sharesoft.validatePassword( password, repeatPassword, self.showError ) ){ 
                // done
                false;
            }
            else {
        ...
        // FUNCTION: showError( string: error ) void
            ...
            if( error === '' ){
                ...
                // set background color
                $( '#' + self.errorOptions['id'] ).css( 'background-color', sharesoft.colors['errorDialogBackgroundColor']['color'] );
            }
